-- DROP FUNCTION fn_cross_selling;
CREATE
OR REPLACE FUNCTION fn_cross_selling(
...
--TESTS
SELECT *
FROM fn_cross_selling(2, 3, 0.7, 70, 30);
SELECT *
FROM fn_cross_selling(6, 4, 0.7, 80, 30);
SELECT *
FROM fn_cross_selling(2, 4, 0.7, 100, 30);
SELECT *
FROM fn_cross_selling(1, 3, 0.9, 70, 50);
