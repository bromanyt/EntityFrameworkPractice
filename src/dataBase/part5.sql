-- DROP FUNCTION fn_increasing_frequency_of_visits;
CREATE
OR REPLACE FUNCTION fn_increasing_frequency_of_visits(
...
--TESTS
SELECT *
FROM fn_increasing_frequency_of_visits('2022-08-18 00:00:00', '2022-08-18 00:00:00', 2, 3, 70, 30);
SELECT *
FROM fn_increasing_frequency_of_visits('2022-08-18 00:00:00', '2022-08-18 00:00:00', 1, 1, 70, 30);
SELECT *
FROM fn_increasing_frequency_of_visits('2022-08-18 00:00:00', '2022-08-18 00:00:00', 1, 3, 90, 30);
SELECT *
FROM fn_increasing_frequency_of_visits('2022-08-18 00:00:00', '2022-08-18 00:00:00', 1, 10, 90, 10);
SELECT *
FROM fn_increasing_frequency_of_visits('2022-08-18 00:00:00', '2022-08-18 00:00:00', 1, 40, 50, 10);
