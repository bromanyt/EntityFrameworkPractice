CREATE
    OR REPLACE FUNCTION fn_customer_average_check(CUSTOMER_ID_ BIGINT, DATE_FROM DATE default null,
...
CREATE
    OR REPLACE FUNCTION fn_offer_discount(CUSTOMER_ID_ BIGINT, ALLOWABLE_DISCOUNT DECIMAL, OFFERED_GROUPS BIGINT[])
    RETURNS BIGINT[]
AS
$$
DECLARE
...
CREATE
    OR REPLACE FUNCTION fn_offer_group_list(CUSTOMER_ID_ BIGINT, CHURN_INDEX DECIMAL, SHARE_WITH_DISCOUNT DECIMAL)
    RETURNS BIGINT[]
AS
$$
DECLARE
...
CREATE
    OR REPLACE FUNCTION fn_grow_check(METHOD INTEGER, DATE_FROM DATE default null, DATE_TILL DATE default null,
...
--TESTS
SELECT *
FROM fn_grow_check(2, null, null, 100, 1, 1, 70, 90);
SELECT *
FROM fn_grow_check(2, null, null, 100, 1.15, 3, 70, 80);
SELECT *
FROM fn_grow_check(2, '2022-05-01', null, 10, 2, 5, 70, 30);
SELECT *
FROM fn_grow_check(2, null, null,
                   250, 1, 3, 70, 30);
...
--no result
SELECT *
FROM fn_grow_check(2, '2022-01-01', '2023-07-02',
                   5, 0.55, 3, 30, 60);
--error
SELECT *
FROM fn_grow_check(2, null, null,
...
SELECT *
FROM fn_grow_check(1, '2018-01-20', '2022-08-20',
                   null, 1.15, 3, 70, 30);

--no result
SELECT *
FROM fn_grow_check(1, '2023-01-20', '2023-08-20',
                   null, 1.35, 2, 60, 30);

--error
SELECT *
FROM fn_grow_check(1, '2018-01-40', '2022-08-20',
                   null, 1.35, 2, 60, 30);