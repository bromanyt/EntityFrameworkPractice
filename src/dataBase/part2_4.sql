-- DROP FUNCTION  fn_create_groups_view;
CREATE
OR REPLACE FUNCTION fn_create_groups_view(days_count BIGINT DEFAULT 1700, transactions_count BIGINT DEFAULT 1700)
    RETURNS TABLE
    (
        "Customer_id" BIGINT,
        "Group_id" BIGINT,
